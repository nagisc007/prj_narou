...
def sc_fantasytown(w: wd.World):
    ...
    return w.scene("目覚めたらリンギ",
            ak.do().d("脇腹に痛みを感じて", "ゆっくりと目を開く"),
            ringi.ask().t("あんちゃん大丈夫かい？"),
            ak.think().d("目の前のモヒカン頭に「あんちゃん」呼ばわりされる覚えはなかったが",
                "とにかく「大丈夫だ」と答えて上体を起こした"),
            ak.think().d("ここはどこだ？"),
            ak.look().d("$meは周囲を見回して",
                "自分が石畳の路上に坐っているのだと理解する"),
            ak.talk().t("痛ってぇなあ……何だこれ？"),
            ak.look().d("それは自分の体の下に落ちていた一個の林檎だった。",
                "これがちょうど脇腹のところにあったから", "あれほどの痛みを感じたのだろうか"),
            ...
            ringi.ask().t("亜人は亜人だよ。",
                "犬の耳がついてたり", "狼男だったり……", "ほら",
                "あそこを今走っていく猫耳の女の子とか"),
            ak.look(w.i.minae_hight.flag()).d("モヒカンに指を差されて振り返ると",
                "身長百四十くらいだろうか。",
            ...
            ak.look(w.i.minae_point.flag()).d("左目のところに小指の先ほどのサイズの黒子が見えたからだ"),
            ak.think().d("それは学生時代に失恋をした", "$n_minaeのそれによく似ていた"),
            ak.look(w.blackcloak).d("その猫耳の彼女の後を", "黒マントを着た複数の男が追いかけていく"),
